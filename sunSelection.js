...
(function ($v, $w) {
    function CreateSelector(Selectiondata, options, componentName) {
        ...
        var lifeCircy = util.common._FacShell({
            created: function () {
                scope = this;
        ...
        var tamplate = "";
        var _data = util.common._FacShell({
            lineData: lineData,
            mainData: mainData,
        ...
        var props = util.common._FacShell({
        ...
        return initSelector(Selectiondata, options, componentName);
    }
    $w.CreateSelector = CreateSelector;
})(Vue, window)
